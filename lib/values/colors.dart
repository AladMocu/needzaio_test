...
class AppColors {
  ...
  static const Color secondaryElement = Color.fromARGB(255, 254, 221, 124);
  static const Color accentElement = Color.fromARGB(255, 255, 244, 214);
  static const Color primaryText = Color.fromARGB(255, 26, 26, 26);
  ...
  static const Color lineColor = Color.fromARGB(178, 52, 76, 105);
  ...
  static const Color greyShade1 = Color(0x29000000);
  //indigo
